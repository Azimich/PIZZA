...
function PizzaBlock({ name, imageUrl, price, types, sizes }) {
  ...
  >
    <circle cx="109" cy="105" r="109" /> 
    <rect x="0" y="231" rx="4" ry="4" width="223" height="30" /> 
    <rect x="0" y="273" rx="2" ry="2" width="227" height="86" /> 
    <rect x="106" y="370" rx="20" ry="20" width="117" height="35" /> 
